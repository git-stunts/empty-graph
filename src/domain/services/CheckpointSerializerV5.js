 ...
 */
export function serializeFullStateV5(state, { codec } = /** @type {*} */ ({})) {
...
export function deserializeFullStateV5(buffer, { codec: codecOpt } = /** @type {*} */ ({})) {
 ...
 */
export function serializeAppliedVV(vv, { codec } = /** @type {*} */ ({})) {
  const c = codec || defaultCodec;
 ...
 */
export function deserializeAppliedVV(buffer, { codec } = /** @type {*} */ ({})) {
  const c = codec || defaultCodec;
